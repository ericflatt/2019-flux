...
function processDocument(doc, options) {
    ...
    const node = Object.assign({}, withRefs, rawAliases, { id: createNodeId(overlayDrafts ? unprefixDraftId_1.unprefixDraftId(doc._id) : doc._id), parent: null, children: [], internal: {
