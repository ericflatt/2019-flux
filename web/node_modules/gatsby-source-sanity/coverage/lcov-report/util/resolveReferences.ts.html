...
<html lang="en">
<head>
    <title>Code coverage report for util/resolveReferences.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">util</a> resolveReferences.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {GatsbyNode, GatsbyNodeIdCreator} from '../types/gatsby'
...
export function resolveReferences(
  ...
  options: Partial&lt;ResolveReferencesOptions&gt; = <span class="branch-0 cbranch-no" title="branch not covered" >{},</span>
  currentDepth = 0,
): any {
...
&nbsp;
  if (Array.isArray(obj)) {
    return currentDepth &lt;= maxDepth
      ...
      : <span class="branch-1 cbranch-no" title="branch not covered" >obj</span>
  }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (isRawDataField) {
<span class="cstat-no" title="statement not covered" >      targetKey = `_raw${key.slice(8)}`</span>
    }
&nbsp;
    acc[targetKey] = value
    return acc
...
function resolveGatsbyReference(value: string | string[], context: MinimalGatsbyContext) {
  ...
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (Array.isArray(value)) {
    return value.map(id =&gt; getNode(id))
  } else {
<span class="cstat-no" title="statement not covered" >    throw new Error(`Unknown Gatsby node reference: ${value}`)</span>
  }
}
&nbsp;</pre></td></tr>
</table></pre>
