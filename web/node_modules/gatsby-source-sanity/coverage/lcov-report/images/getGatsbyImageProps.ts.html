...
<html lang="en">
<head>
    <title>Code coverage report for images/getGatsbyImageProps.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">images</a> getGatsbyImageProps.ts
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>108/118</span>
      </div>
    </div>
    <p class="quiet">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import * as parseUrl from 'url-parse'
&nbsp;
...
&nbsp;
  ...
  if (typeof node === 'string') {
    id = node
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (obj.asset) {
<span class="cstat-no" title="statement not covered" >    id = (obj.asset as ImageRef)._ref || (obj.asset as ImageAsset)._id</span>
  } else {
    id = ref._ref || img._id
  }
&nbsp;
  const hasId = !id || idPattern.test(id)
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!hasId) {
<span class="cstat-no" title="statement not covered" >    return false</span>
  }
&nbsp;
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (isConvertedToTarget &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >isOriginal)</span> {
    const <span class="cstat-no" title="statement not covered" >{f</span>m<span class="cstat-no" title="statement not covered" >, <span class="cstat-no" title="statement not covered" >.</span>..params} = parsed.query</span>
<span class="cstat-no" title="statement not covered" >    parsed.set('query', params)</span>
<span class="cstat-no" title="statement not covered" >    return parsed.toString()</span>
  }
&nbsp;
...
export function getFixedGatsbyImage(
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!props) {
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (args.toFormat) {
<span class="cstat-no" title="statement not covered" >    forceConvert = args.toFormat</span>
...
&nbsp;
  ...
  const srcSets = widths
    ...
    .reduce((acc, currentWidth, i) =&gt; {
      ...
      const baseUrl = convertToFormat(imgUrl, forceConvert || <span class="branch-1 cbranch-no" title="branch not covered" >props.extension)</span>
